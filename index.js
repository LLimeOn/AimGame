...
function animate() {
	...
	projectiles.forEach((projectile, index) => {
		...
		// if (projectile.x + projectile.radius < 0 || projectile.x - projectile.radius > canvas.width || projectile.y + projectile.radius < 0 || projectile.y - projectile.radius > caanvas.height) {
		if (
